                ...
                <form id="formAdd">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="unit_name" class="col-sm-2 col-form-label">ชื่อ{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="ชื่อ{{$title}}" class="form-control" name="unit_name" placeholder="ชื่อ{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <form id="formEdit">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="unit_name" class="col-sm-2 col-form-label">ชื่อ{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="ชื่อ{{$title}}" class="form-control" name="unit_name" id="unit_name" placeholder="ชื่อ{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="description" class="col-sm-2 col-form-label">สถานะ{{$title}}</label>
...
<script type="text/javascript">
    ...
    function changeStatus(id,value){
        $.ajax({
            ...
            method : "post",
            url : url+"/admin/units/changeStatus",
            dataType : 'json',
            data : {
                'id':id,
                'status':value
