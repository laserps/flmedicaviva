                                ...
                                <table class="table table-striped table-bordered table-hover flip-content table-sm" id="datatableAll">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">เลขบัญชี{{$title}}</th>
                ...
                <form id="formAdd">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-2 col-form-label">ชื่อ{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="ชื่อ{{$title}}" class="form-control" name="bank_name" placeholder="ชื่อ{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="category_name" class="col-sm-2 col-form-label">เลขบัญชี{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="เลขบัญชี{{$title}}" class="form-control" name="bank_code" placeholder="เลขบัญชี{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <form id="formEdit">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="bank_name" class="col-sm-2 col-form-label">ชื่อ{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="ชื่อ{{$title}}" class="form-control" name="bank_name" id="bank_name" placeholder="ชื่อ{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="bank_code" class="col-sm-2 col-form-label">เลขบัญชี{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="เลขบัญชี{{$title}}" class="form-control" name="bank_code" id="bank_code" placeholder="เลขบัญชี{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="description" class="col-sm-2 col-form-label">สถานะ{{$title}}</label>
...
<script type="text/javascript">
    ...
    $('body').on('click', '.edit-data', function(){
        ...
        $.ajax({
            ...
            $( "#bank_id" ).val( id );
            $( "#bank_name" ).val( rec.bank_name );
            $( "#bank_code" ).val( rec.bank_code );
            //$( "#category_image" ).val(  );
    ...
    function changeStatus(id,value){
        $.ajax({
            ...
            method : "post",
            url : url+"/admin/banks/changeStatus",
            dataType : 'json',
            data : {
                'id':id,
                'status':value
