                ...
                <form id="formAdd">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="order_firstname" class="col-sm-2 col-form-label">ชื่อ - นามสกุล{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="text" class="form-control" name="name" placeholder="ชื่อ{{$title}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="order_lastname" class="col-sm-2 col-form-label">อายุ{{$title}}</label>
                            <div class="col-sm-10">
                ...
                <form id="formEdit">
                    ...
                    <div class="modal-body">
                        <div class="form-group row">
                            <label for="order_firstname" class="col-sm-2 col-form-label">ชื่อ - นามสกุล{{$title}}</label>
                            <div class="col-sm-10">
                            <input type="hidden" class="form-control" id="order_id" name="id" placeholder="id_{{$title}}">
